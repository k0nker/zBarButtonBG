            ...
            indicators = {
                ...
                args = {
                    ...
                    cooldownColor = {
                        ...
                        hidden = function() return not zBarButtonBG.midnightCooldown end,
                        disabled = function()
                            return not zBarButtonBG.midnightCooldown or
                                not self.db.profile.fadeCooldown
                        end,
                        hasAlpha = true,
                        get = function()
                ...
                args = {
                    ...
                    resetMacroSettings = {
                        ...
                        func = function()
                            ...
                            self.db.profile.macroNameColor = {
                                r = defaults.macroNameColor.r,
                                g = defaults
                                    .macroNameColor.g,
                                b = defaults.macroNameColor.b,
                                a = defaults.macroNameColor.a
                            }
                    ...
                    resetCountSettings = {
                        ...
                        func = function()
                            ...
                            self.db.profile.countColor = {
                                r = defaults.countColor.r,
                                g = defaults.countColor.g,
                                b =
                                    defaults.countColor.b,
                                a = defaults.countColor.a
                            }
                    ...
                    resetKeybindSettings = {
                        ...
                        func = function()
                            ...
                            self.db.profile.keybindColor = {
                                r = defaults.keybindColor.r,
                                g = defaults.keybindColor.g,
                                b =
                                    defaults.keybindColor.b,
                                a = defaults.keybindColor.a
                            }
