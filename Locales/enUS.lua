...
L["Delete the chosen profile"] = "Delete the chosen profile"
...
L["Enter a name for the new imported profile"] = "Enter a name for the new imported profile"
...
L["Tint the backdrop with your class color"] = "Tint the backdrop with your class color"
L["Tint the slot background with your class color"] = "Tint the slot background with your class color"
L["Tint the border with your class color"] = "Tint the border with your class color"
L["Color"] = "Color"
...
-- Size descriptions
L["Font size for macro names"] = "Font size for macro names"
L["Font size for count/charge numbers"] = "Font size for count/charge numbers"
L["Font size for keybind/hotkey text"] = "Font size for keybind/hotkey text"
...
L["Horizontal text alignment for macro names"] = "Horizontal text alignment for macro names"
...
L["Hexagon"] = "Hexagon"
L["Rhomboid"] = "Rhomboid"
L["Rhomboid Flipped"] = "Rhomboid Flipped"
L["Rhomboid Tall"] = "Rhomboid Tall"
L["Rhomboid Tall Flipped"] = "Rhomboid Tall Flipped"
...
L["Rhomboid button style"] = "Rhomboid button style"
L["Rhomboid flipped button style"] = "Rhomboid flipped button style"
L["Rhomboid tall button style"] = "Rhomboid tall button style"
L["Rhomboid tall flipped button style"] = "Rhomboid tall flipped button style"
...
L["Mask Backdrop"] = "Mask Backdrop"
L["Mask outer background frame"] = "Mask outer background frame"
L["Mask outer background frame to button shape"] = "Mask outer background frame to button shape"
L["Show outer background frame"] = "Show outer background frame"
L["Show the slot background fill behind each button icon"] = "Show the slot background fill behind each button icon"
...
L["Use a different profile for this action bar"] = "Use a different profile for this action bar"
L["Select which profile to use"] = "Select which profile to use"
L["Profile to use for this action bar"] = "Profile to use for this action bar"
L["Count / Charge"] = "Count / Charge"
L["Keybind / Hotkey"] = "Keybind / Hotkey"
