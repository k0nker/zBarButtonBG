...
L["Show or hide the macro name label on buttons"] = "버튼의 매크로 이름 레이블을 표시하거나 숨깁니다"
L["Show Keybind Text"] = "단축키 텍스트 표시"
L["Show or hide the keybind/hotkey label on buttons"] = "버튼의 단축키/핫키 레이블을 표시하거나 숨깁니다"
L["Shorten Keybind"] = "단축키 축약"
L["Abbreviate modifier keys in keybind text (e.g. Ctrl-Shift-Alt-1 becomes CSA1)"] = "단축키 텍스트에서 수정 키를 축약합니다 (예: Ctrl-Shift-Alt-1이 CSA1이 됩니다)"
...
L["Bar 6"] = "막대 6"
L["Bar 7"] = "막대 7"
L["Bottom Left Bar"] = "왼쪽 아래 막대"
L["Bottom Right Bar"] = "오른쪽 아래 막대"
L["Circle"] = "원"
L["Circle button style"] = "원형 버튼 스타일"
L["Color of the button border"] = "버튼 테두리의 색상"
L["Color of the button slot background"] = "버튼 슬롯 배경의 색상"
L["Color of the cooldown overlay"] = "쿨다운 오버레이의 색상"
L["Color of the count/charge text"] = "카운트/충전 텍스트의 색상"
L["Color of the keybind/hotkey text"] = "단축키 텍스트의 색상"
L["Color of the macro name text"] = "매크로 이름 텍스트의 색상"
L["Color of the out of range indicator"] = "범위 밖 표시기의 색상"
L["Color of the outer backdrop frame"] = "외부 배경 프레임의 색상"
L["Equipment Outline"] = "장비 개요"
