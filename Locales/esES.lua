...
L["Proc Alt Glow Color"] = "Color de alerta"
...
L["Are you sure you want to delete the profile: "] = "¿Estás seguro de que deseas eliminar el perfil: "
L["Bar 5"] = "Barra 5"
L["Bar 6"] = "Barra 6"
L["Bar 7"] = "Barra 7"
...
L["Color of the button slot background"] = "Color del fondo de la ranura del botón"
L["Color of the cooldown overlay"] = "Color de la superposición de enfriamiento"
L["Color of the count/charge text"] = "Color del texto de cuenta/carga"
L["Color of the equipment item border outline"] = "Color del contorno del borde del artículo de equipo"
L["Color of the keybind/hotkey text"] = "Color del texto de atajo de teclado"
L["Color of the macro name text"] = "Color del texto del nombre de la macro"
L["Color of the out of range indicator"] = "Color del indicador fuera de rango"
L["Color of the outer backdrop frame"] = "Color del marco de fondo externo"
L["Copy settings from: "] = "Copiar configuración de: "
L["Equipment Outline"] = "Contorno de equipo"
L["Export Profile"] = "Exportar perfil"
L["Export current profile settings as a string"] = "Exportar la configuración del perfil actual como una cadena"
