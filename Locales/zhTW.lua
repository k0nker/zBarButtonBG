...
L["Show or hide the macro name label on buttons"] = "顯示或隱藏按鈕上的巨集名稱標籤"
L["Show Keybind Text"] = "顯示按鍵綁定文字"
L["Show or hide the keybind/hotkey label on buttons"] = "顯示或隱藏按鈕上的按鍵綁定/熱鍵標籤"
L["Shorten Keybind"] = "縮短按鍵綁定"
L["Abbreviate modifier keys in keybind text (e.g. Ctrl-Shift-Alt-1 becomes CSA1)"] = "縮寫按鍵綁定文字中的修飾鍵（例如 Ctrl-Shift-Alt-1 變成 CSA1）"
