...
L["Show or hide the macro name label on buttons"] = "Показать или скрыть метку имени макроса на кнопках"
L["Show Keybind Text"] = "Показать текст клавиш"
L["Show or hide the keybind/hotkey label on buttons"] = "Показать или скрыть метку клавиши/хоткея на кнопках"
L["Shorten Keybind"] = "Сократить клавиши"
L["Abbreviate modifier keys in keybind text (e.g. Ctrl-Shift-Alt-1 becomes CSA1)"] = "Сокращать клавиши-модификаторы в тексте привязки (напр. Ctrl-Shift-Alt-1 станет CSA1)"
...
L["Are you sure you want to reset all keybind/hotkey text settings to default values?\n\nThis will reset font, size, color, positioning, and shortening settings for keybind/hotkey text.\n\nThis action cannot be undone!"] = "Вы уверены, что хотите сбросить все настройки текста клавиш/хоткеев к значениям по умолчанию?\n\nЭто сбросит шрифт, размер, цвет, позиционирование и настройки сокращения для текста клавиш.\n\nЭто действие невозможно отменить!"
