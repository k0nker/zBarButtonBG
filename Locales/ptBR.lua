...
L["Profile to replace all bars when in combat"] = "Perfil para substituir todas as barras em combate"
...
L["Proc Alt Glow Color"] = "Cor de Alerta"
...
L["Circle"] = "Círculo"
L["Circle button style"] = "Estilo de botão circular"
L["Color of the button border"] = "Cor da borda do botão"
L["Color of the button slot background"] = "Cor do fundo do slot do botão"
L["Color of the cooldown overlay"] = "Cor da sobreposição de recarga"
L["Color of the count/charge text"] = "Cor do texto de contagem/carga"
L["Color of the equipment item border outline"] = "Cor do contorno da borda do item de equipamento"
L["Color of the keybind/hotkey text"] = "Cor do texto de atalho do teclado"
L["Color of the macro name text"] = "Cor do texto do nome da macro"
L["Color of the out of range indicator"] = "Cor do indicador fora do alcance"
L["Color of the outer backdrop frame"] = "Cor do quadro de fundo externo"
